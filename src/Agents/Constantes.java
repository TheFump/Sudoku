...
public class Constantes {
	...
	public static final String MESSAGE_AGENT_READY = "Ready";
	...
	public static final String SIMULATION_NAME = "Simulation";
	public static final String EFFECTEUR_NAME = "Effecteur";
